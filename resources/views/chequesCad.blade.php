...
@section('content')
    ...
    <div class="faq-sec overflow-hidden space"  style="background-image: linear-gradient(to right, #fffdfd 36%, #fde9c7 28%);">
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <img src="{{asset('assets/img/normal/tech5.jpg')}}"
                         alt="Avater">
                </div>
                <div class="col-xl-6">
                    <div class="ps-xl-4">
    ...
    <section class="space overflow-hidden"  id="cheque">
            ...
            <div class="row ">
                <div class="col-md-6 col-xl-3">
                    <div class="blog-card wow fadeInUp">
                        <div class="blog-img"><img src="{{asset('assets/img/blog/blog_1_1.jpg')}}" alt="blog image"></div>
                        <div class="blog-card_wrapper">
                            ...
                            <div class="blog-card-content">
                                ...
                                <a href="" class="line-btn searchBoxToggler1" >Lire la suite</i></a><br>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="blog-card wow fadeInDown">
                        <div class="blog-img"><img src="{{asset('assets/img/blog/blog_1_2.jpg')}}" alt="blog image"></div>
                        <div class="blog-card_wrapper">
                            ...
                            <div class="blog-card-content">
                                ...
                                <a href="#bob" class="line-btn searchBoxToggler1 ">Lire la suite</i></a><br>
                                <a href="{{route('bonAchat')}}"  class="line-btn">Acheter</i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="blog-card wow fadeInUp">
                        <div class="blog-img"><img src="{{asset('assets/img/blog/blog_1_3.jpg')}}" alt="blog image"></div>
                        <div class="blog-card_wrapper">
                            <div class="blog-card-content">
                                <div class="blog-meta">
                                    <span>50.00 €</span>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="blog-card wow fadeInDown">
                        <div class="blog-img"><img src="{{asset('assets/img/blog/blog_1_4.jpg')}}" alt="blog image"></div>
                        <div class="blog-card_wrapper">
        ...
        <div class="shape-mockup jump d-none d-lg-block" data-top="0%" data-left="0%"><img
                src="{{asset('assets/img/shape/leaves_3.png')}}" alt="shape"></div>
        <div class="shape-mockup d-none d-xxl-block" data-bottom="0%" data-right="0%"><img
                src="{{asset('assets/img/shape/flower_1_2.png')}}" alt="shape"></div>
    </section>
