            ...
            <div class="row justify-content-between">
                ...
                <div class="col-md-6 col-xl-2">
                    <div class="widget widget_nav_menu footer-widget">
                        <h3 class="widget_title">Epilation Lazer</h3>
                ...
                <div class="col-md-6 col-xl-2">
                    <div class="widget widget_nav_menu footer-widget">
                        <h3 class="widget_title">L'institut</h3>
                        <div class="menu-all-pages-container">
                            <ul class="menu">
                ...
                <div class="col-md-6 col-xl-auto">
                    <div class="widget footer-widget">
                        <h3 class="widget_title">Nos coordonnées</h3>
                        <div class="th-widget-about">

                            <p class="footer-info"><i class="fa-sharp fa-solid fa-phone"></i><a class="text-inherit"
                                                                                                href="tel:+256214203215"> +32 470 37 90 18</a></p>
