...
<div class="breadcumb-wrapper" data-bg-src="assets/img/breadcumb/breadcumb-bg.jpg">
    ...
    <section class="th-blog-wrapper space-top space-extra-bottom"  style="padding-top: 80px;">
        ...
        <div class="filter-menu style2 indicator-active filter-menu-active">
                ...
                <button data-filter=".cat1" class="tab-btn" type="button">Visage</button>
                <button data-filter=".cat2" class="tab-btn" type="button">Bras</button>
                <button data-filter=".cat3" class="tab-btn" type="button">Jambes</button>
                <button data-filter=".cat4" class="tab-btn" type="button">Corps</button>
